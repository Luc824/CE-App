...
const WOMENS_HEPTATHLON_EVENTS = [
  [
    { name: "100m Hurdles", placeholder: "12.69", type: "track" },
    { name: "High Jump", placeholder: "1.86", type: "field" },
  ],
  [
    { name: "Shot Put", placeholder: "15.80", type: "field" },
    { name: "200m", placeholder: "22.56", type: "track" },
  ],
  [
    { name: "Long Jump", placeholder: "6.27", type: "field" },
    { name: "Javelin Throw", placeholder: "45.66", type: "field" },
  ],
  [
    { name: "800m", placeholder: "2:08.51", type: "track" },
    { name: "", placeholder: "", type: "none" }, // Empty slot for alignment
  ],
];

export default function WomensHeptathlonCalculator() {
  const [results, setResults] = useState<Record<string, EventResult>>(
    WOMENS_HEPTATHLON_EVENTS.flat()
      ...
      <SafeAreaView style={styles.safeArea}>
        <ScrollView style={styles.scrollView}>
          <View style={styles.container}>
            ...
            {WOMENS_HEPTATHLON_EVENTS.map((pair, pairIndex) => (
                ...
                <View style={styles.columnContainer}>
                  <View style={styles.eventContainer}>
                    ...
                    <TextInput
                      ...
                      maxLength={pair[0].name === "800m" ? 8 : 6}
                      autoCapitalize="none"
                    />
                  </View>
                </View>
                  ...
                  <View style={styles.columnContainer}>
                    <View style={styles.eventContainer}>
                      ...
                      <TextInput
                        ...
                        returnKeyType="done"
                        onSubmitEditing={Keyboard.dismiss}
                        maxLength={pair[1].name === "800m" ? 8 : 6}
                        autoCapitalize="none"
                      />
                    </View>
                  </View>
