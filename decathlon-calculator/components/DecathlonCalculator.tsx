...
const DECATHLON_EVENTS = [
  [
    { name: "100m", placeholder: "10.55", type: "track" },
  ...
  [
    { name: "400m", placeholder: "48.42", type: "track" },
    { name: "110m Hurdles", placeholder: "13.75", type: "track" },
  ],
  [
    { name: "Discus Throw", placeholder: "50.54", type: "field" },
    { name: "Pole Vault", placeholder: "5.45", type: "field" },
  ],
  [
    { name: "Javelin Throw", placeholder: "71.90", type: "field" },
    { name: "1500m", placeholder: "4:36.11", type: "track" },
  ],
];

export default function DecathlonCalculator() {
  const [results, setResults] = useState<Record<string, EventResult>>(
    DECATHLON_EVENTS.flat().reduce(
      (acc, event) => ({
        ...acc,
        [event.name]: {
          event: event.name,
        ...
        <ScrollView style={styles.scrollView}>
          <View style={styles.container}>
            <ThemedText style={styles.mainTitle}>
              Men's Decathlon Points Calculator
            </ThemedText>
            {DECATHLON_EVENTS.map((pair, pairIndex) => (
                ...
                <View style={styles.columnContainer}>
                  <View style={styles.eventContainer}>
                    ...
                    <TextInput
                      ...
                      maxLength={pair[0].name === "1500m" ? 8 : 6}
                      autoCapitalize="none"
                    />
                  </View>
                </View>
                ...
                <View style={styles.columnContainer}>
                  <View style={styles.eventContainer}>
                    ...
                    <TextInput
                      ...
                      returnKeyType="done"
                      onSubmitEditing={Keyboard.dismiss}
                      maxLength={pair[1].name === "1500m" ? 8 : 6}
                      autoCapitalize="none"
                    />
                  </View>
                </View>
